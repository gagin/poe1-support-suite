...
- **Mirage coin economy**: Coins of Power/Knowledge/Skill have market value (gamblers buy them) but self-use EV is too low — always sell them. Coins of Restoration drop commonly and are essentially worthless/free; the Afarud→Maraketh conversion is costless. Sigil icons on the wish screen determine which coin type drops in that Mirage (Ruzhan=Power, Navira=Knowledge, Kelari=Skill; Restoration drops from any wish).
